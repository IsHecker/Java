...
public class StartInterface extends javax.swing.JFrame implements ActionListener{
    ...
    private JTextField URL_textField = new TextField("jdbc:sqlserver://localhost;databaseName=DBConnection;", 105,  20, width * 5, height);
    ...
    private JComboBox<String> tableSelection = new ComboBox(new String[]{"Books","Author","Publisher"}, 115 + width + 50,  50, width, height);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == connectButton)
        {
            ...
            Table t = new Table(5, 5, 700,URL_textField.getText(),props,tableSelection.getSelectedItem().toString());
        }
    }
